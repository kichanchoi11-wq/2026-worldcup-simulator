export const storageKeys = {
  ...
  geminiAnalysesData: "worldCupGeminiAnalyses",
  geminiStatusData: "worldCupGeminiStatus",
  geminiFreshInfoData: "worldCupGeminiFreshInfo",
  geminiFreshInfoStatusData: "worldCupGeminiFreshInfoStatus",
  ...
  geminiDiagnosticsData: "worldCupGeminiDiagnostics",
...
const migratableStorageKeys: StorageKey[] = [
  ...
  storageKeys.geminiAnalysesData,
  storageKeys.geminiStatusData,
  storageKeys.geminiFreshInfoData,
  storageKeys.geminiFreshInfoStatusData,
  ...
  storageKeys.geminiDiagnosticsData,
