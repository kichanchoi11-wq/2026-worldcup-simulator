...
const toneClass: Record<string, string> = {
  ...
  "신뢰도 높음": "border-emerald-300/50 bg-emerald-400/15 text-emerald-50",
  예상: "border-cyan-300/50 bg-cyan-400/15 text-cyan-50",
  ...
  "체력 변수": "border-lime-300/50 bg-lime-400/15 text-lime-50",
